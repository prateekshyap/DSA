...
|  3  |Combination Sum|[LC](https://leetcode.com/problems/combination-sum/) [GFG](https://practice.geeksforgeeks.org/problems/combination-sum-1587115620/1) |[CPP](./BackTracking/LC_39_CombinationSum.cpp) [Java](./BackTracking/CombinationSum.java) |Medium|O(n)||
|  4  |Combination Sum Ii|[LC](https://leetcode.com/problems/combination-sum-ii/) |[CPP](./BackTracking/LC_40_CombinationSumII.cpp) [Java](./BackTracking/CombinationSum2.java) ||O(n)||
|  5  |Combination Sum Iii|[LC](https://leetcode.com/problems/combination-sum-iii/) |[CPP](./BackTracking/LC_216_CombinationSumII.cpp) [Java](./BackTracking/CombinationSum3.java) ||O(n)||
|  6  |Combination Sum Iv|[LC](https://leetcode.com/problems/combination-sum-iv/) |[CPP](./BackTracking/LC_377_CombinationSumIV.cpp) [Java](./BackTracking/CombinationSum4.java) ||O(n)||
...
|  12  |Minimum Genetic Mutation|[LC](https://leetcode.com/problems/minimum-genetic-mutation/) |[Java](./BackTracking/MinimumGeneticMutation.java) ||O(n<sup>3</sup>)||
|  13  |N Queens|[LC](https://leetcode.com/problems/n-queens/) |[Java](./BackTracking/NQueenSolver.java) ||O(n<sup>2</sup>)||
|  14  |Number Of Paths0926|[GFG](https://practice.geeksforgeeks.org/problems/number-of-paths0926/1#) |[CPP](./BackTracking/GFG_NumOfPaths.cpp) [Java](./BackTracking/PossiblePaths.java) |Easy|O(1)||
|  15  |Palindrome Partitioning|[LC](https://leetcode.com/problems/palindrome-partitioning/) [GFG](https://practice.geeksforgeeks.org/problems/find-all-possible-palindromic-partitions-of-a-string/1/) |[Java](./BackTracking/PalindromicPartition.java) |Hard|O(n)||
|  16  |Palindrome Partitioning Ii|[LC](https://leetcode.com/problems/palindrome-partitioning-ii/) |[Java](./BackTracking/MinimumNumberOfPartitions.java) ||O(n)||
|  17  |Partition A Set Into Two Subsets Such That The Difference Of Subset Sums Is Minimum Set 2|[GFG](https://practice.geeksforgeeks.org/problems/partition-a-set-into-two-subsets-such-that-the-difference-of-subset-sums-is-minimum-set-2/1/) |[Java](./BackTracking/PartitionIntoSubsetsOfMinimumDifference.java) |Hard|O(1)||
...
|  19  |Permutations|[LC](https://leetcode.com/problems/permutations/) [GFG](https://practice.geeksforgeeks.org/problems/permutations-of-a-given-string-1587115620/1#) |[CPP](./BackTracking/GFG_StringPermutations.cpp) [Java](./BackTracking/Permutation.java) |Easy|O(1)||
|  20  |Permutations Ii|[LC](https://leetcode.com/problems/permutations-ii/) |[CPP](./BackTracking/LC_47_Permutations2.cpp) [Java](./BackTracking/IntegersWithDuplicatesPermutation.java) ||O(n)||
|  21  |Rat In A Maze Problem|[GFG](https://practice.geeksforgeeks.org/problems/rat-in-a-maze-problem/1#) |[CPP](./BackTracking/GFG_RatInMaze.cpp) [Java](./BackTracking/RatInMaze.java) |Medium|O(1)||
|  22  |Remove Invalid Parentheses|[LC](https://leetcode.com/problems/remove-invalid-parentheses/) |[Java](./BackTracking/RemoveInvalidParentheses.java) ||O(n)||
|  23  |Restore Ip Addresses|[LC](https://leetcode.com/problems/restore-ip-addresses/) [GFG](https://practice.geeksforgeeks.org/problems/generate-ip-addresses/1) |[CPP](./BackTracking/LC_93_RestoreIPAddresses.cpp) |Medium|O(1)||
|  24  |Split Array Into Fibonacci Sequence|[LC](https://leetcode.com/problems/split-array-into-fibonacci-sequence/) |[Java](./BackTracking/SplitArrayIntoFibonacciSequences.java) ||O(n)||
|  25  |Subset Sums Between The Given Range|[GFG](https://practice.geeksforgeeks.org/problems/subset-sums-between-the-given-range/1/) |[Java](./BackTracking/SubsetSumsBetweenTheGivenRange.java) |Hard|O(n<sup>2</sup>)||
|  26  |Sudoku Solver|[LC](https://leetcode.com/problems/sudoku-solver/) [GFG](https://practice.geeksforgeeks.org/problems/solve-the-sudoku-1587115621/1) |[CPP](./BackTracking/LC_37_SudokuSolver.cpp) [Java](./BackTracking/SudokuSolver.java) |Hard|O(1)||
|  27  |Travelling Salesman Problem2732|[GFG](https://practice.geeksforgeeks.org/problems/travelling-salesman-problem2732/1/) |[Java](./BackTracking/TravellingSalesmanProblem.java) |Hard|O(n)||
|  28  |Unique Paths Iii|[LC](https://leetcode.com/problems/unique-paths-iii/) |[CPP](./BackTracking/LC_980_UniquePathsIII.cpp) ||O(1)||
|  29  |Word Break Ii|[LC](https://leetcode.com/problems/word-break-ii/) [GFG](https://practice.geeksforgeeks.org/problems/word-break-part-23249/1) |[CPP](./BackTracking/LC_140_WordBreakPart2.cpp) [Java](./BackTracking/WordBreak.java) |Hard|O(1)||
|  30  |Word Ladder Ii|[LC](https://leetcode.com/problems/word-ladder-ii/) [GFG](https://practice.geeksforgeeks.org/problems/word-ladder-ii/1) |[CPP](./BackTracking/LC_126_WordLadderII.cpp) [Java](./BackTracking/WordLadder2.java) |null|O(1)||
|  31  |Word Search|[LC](https://leetcode.com/problems/word-search/) |[CPP](./BackTracking/LC_79_WordSearch.cpp) [Java](./BackTracking/WordSearch.java) ||O(1)||
|  32  |Word Search Ii|[LC](https://leetcode.com/problems/word-search-ii/) |[CPP](./BackTracking/LC_212_WordSearchII.cpp) [Java](./BackTracking/WordSearch2.java) ||O(1)||
## Bit-Magic
...
|  7  |Articulation Point 1|[GFG](https://practice.geeksforgeeks.org/problems/articulation-point-1/0/) |[CPP](./Graph/GFG_ArticulationPointI.cpp) [Java](./Graph/ArticulationPoints1.java) |Hard|O(n)||
|  8  |Articulation Point2616|[GFG](https://practice.geeksforgeeks.org/problems/articulation-point2616/1) |[CPP](./Graph/GFG_ArticulationPointII.cpp) |null|O(1)||
|  9  |As Far From Land As Possible|[LC](https://leetcode.com/problems/as-far-from-land-as-possible/) |[Java](./Graph/AsFarFromLandAsPossible.java) ||O(n<sup>2</sup>)||
|  10  |Bfs Traversal Of Graph|[GFG](https://practice.geeksforgeeks.org/problems/bfs-traversal-of-graph/1) |[CPP](./Graph/GFG_BFSTraversal.cpp) [Java](./Graph/BFS.java) |Easy|O(n<sup>2</sup>)||
|  11  |Bridge Edge In Graph|[GFG](https://practice.geeksforgeeks.org/problems/bridge-edge-in-graph/1#) |[CPP](./Graph/GFG_BridgeEdgeInAGraph.cpp) [Java](./Graph/CheckIfBridge.java) |Medium|O(n)||
|  12  |Cheapest Flights Within K Stops|[LC](https://leetcode.com/problems/cheapest-flights-within-k-stops/) |[CPP](./Graph/LC_787_CheapestFlightsWithinKStops.cpp) [Java](./Graph/CheapestFlightWithinKStops.java) ||O(n<sup>3</sup>)||
...
|  10  |Check If A String Contains All Binary Codes Of Size K|[LC](https://leetcode.com/problems/check-if-a-string-contains-all-binary-codes-of-size-k/) |[CPP](./Hashing/LC_1461_CheckIfStringContainsAllBinaryCodesOfSizeK.cpp) [Java](./Hashing/CheckAllBinaryCodesPresence.java) ||O(n)||
|  11  |Continuous Subarray Sum|[LC](https://leetcode.com/problems/continuous-subarray-sum/) |[Java](./Hashing/ContinuousSubarraySum.java) ||O(n<sup>2</sup>)||
|  12  |Count Element Occurences|[GFG](https://practice.geeksforgeeks.org/problems/count-element-occurences/1/) |[Java](./Hashing/CountMoreThanNByKOccurences.java) |Medium|O(n)||
|  13  |Count Good Meals|[LC](https://leetcode.com/problems/count-good-meals/) |[CPP](./Hashing/LC_711_CountGoodMeals.cpp) [Java](./Hashing/CountGoodMeals.java) ||O(n<sup>2</sup>)||
|  14  |Count Number Of Bad Pairs|[LC](https://leetcode.com/problems/count-number-of-bad-pairs/) |[Java](./Hashing/CountNumberOfBadPairs.java) ||O(n)||
|  15  |Count Pairs In Array Divisible By K|[GFG](https://practice.geeksforgeeks.org/problems/count-pairs-in-array-divisible-by-k/1) |[Java](./Hashing/CountPairsInArrayDivisibleByK.java) |Medium|O(n)||
|  16  |Count Triplets 1|[HR](https://www.hackerrank.com/challenges/count-triplets-1/) |[Java](./Hashing/CountTriplets.java) ||O(n)||
|  17  |Ctci Ransom Note|[HR](https://www.hackerrank.com/challenges/ctci-ransom-note/) |[Java](./Hashing/RansomNote.java) ||O(n)||
|  18  |Degree Of An Array|[LC](https://leetcode.com/problems/degree-of-an-array/) |[Java](./Hashing/DegreeOfAnArray.java) ||O(n)||
|  19  |Design A Number Container System|[LC](https://leetcode.com/problems/design-a-number-container-system/) |[CPP](./Hashing/LC_2349_DesignANumContainerSystem.cpp) ||O(1)||
|  20  |Design Hashmap|[LC](https://leetcode.com/problems/design-hashmap/) |[CPP](./Hashing/LC_706_DesignHashMap.cpp) [Java](./Hashing/HashMapDesign.java) ||O(n)||
|  21  |Design Hashset|[LC](https://leetcode.com/problems/design-hashset/) |[CPP](./Hashing/LC_705_DesignHashSet.cpp) [Java](./Hashing/HashSetDesign.java) ||O(n)||
|  22  |Determine If String Halves Are Alike|[LC](https://leetcode.com/problems/determine-if-string-halves-are-alike/) |[Java](./Hashing/DetermineIfStringHalvesAreAlike.java) ||O(n)||
...
|  24  |Find All Numbers Disappeared In An Array|[LC](https://leetcode.com/problems/find-all-numbers-disappeared-in-an-array/) |[CPP](./Hashing/LC_448_FindAllNumbersDisappearedinArray.cpp) [Java](./Hashing/FindDisappearedNumbers.java) ||O(n)||
|  25  |Find Common Characters|[LC](https://leetcode.com/problems/find-common-characters/) |[CPP](./Hashing/LC_1002_FindCommonCharacters.cpp) [Java](./Hashing/FindCommonCharacters.java) ||O(n<sup>2</sup>)||
|  26  |Find Unique Binary String|[LC](https://leetcode.com/problems/find-unique-binary-string/) |[CPP](./Hashing/LC_1980_FindUniqueBinaryString.cpp) [Java](./Hashing/FindMissingBinaryString.java) ||O(n<sup>2</sup>)||
|  27  |First Missing Positive|[LC](https://leetcode.com/problems/first-missing-positive/) |[CPP](./Hashing/LC_41_FirstMissingPositive.cpp) [Java](./Hashing/FirstMissingPositive.java) ||O(n)||
...
|  29  |Group Anagrams|[LC](https://leetcode.com/problems/group-anagrams/) |[Java](./Hashing/GroupAnagrams.java) ||O(n<sup>3</sup>)||
|  30  |In First But Second5423|[GFG](https://practice.geeksforgeeks.org/problems/in-first-but-second5423/1) |[CPP](./Hashing/GFG_FindMissingInSecondArray.cpp) [Java](./Hashing/FindMissingInSecondArray.java) |Medium|O(n)||
|  31  |Longest K Unique Characters Substring0853|[GFG](https://practice.geeksforgeeks.org/problems/longest-k-unique-characters-substring0853/1/) |[CPP](./Hashing/GFG_LongestKUniqueCharSubstring.cpp) |Easy|O(1)||
|  32  |Longest Palindrome By Concatenating Two Letter Words|[LC](https://leetcode.com/problems/longest-palindrome-by-concatenating-two-letter-words/) |[Java](./Hashing/LongestPalindromeByConcatenatingTwoLetterWords.java) ||O(n)||
|  33  |Longest Subarray With Sum Divisible By K1259|[GFG](https://practice.geeksforgeeks.org/problems/longest-subarray-with-sum-divisible-by-k1259/1) |[Java](./Hashing/LongestSubarrayWithSumDivisibleByK.java) |Medium|O(n<sup>2</sup>)||
|  34  |Longest Substring Without Repeating Characters|[LC](https://leetcode.com/problems/longest-substring-without-repeating-characters/) |[CPP](./Hashing/GFG_LC3_LongestUniqueSubstring.cpp) [Java](./Hashing/LongestUniqueSubstring.java) ||O(1)||
|  35  |Max Distance Between Same Elements|[GFG](https://practice.geeksforgeeks.org/problems/max-distance-between-same-elements/1#) |[CPP](./Hashing/GFG_MaxDistanceBwTwoElements.cpp) |Easy|O(1)||
|  36  |Max Sum Of A Pair With Equal Sum Of Digits|[LC](https://leetcode.com/problems/max-sum-of-a-pair-with-equal-sum-of-digits/) |[Java](./Hashing/MaxSumOfPairWithEqualSumOfDigits.java) ||O(n<sup>2</sup>)||
|  37  |Maximum Number Of Pairs In Array|[LC](https://leetcode.com/problems/maximum-number-of-pairs-in-array/) |[Java](./Hashing/MaximumNumberOfPairsInAnArray.java) ||O(n)||
|  38  |Maximum Repeating Number4858|[GFG](https://practice.geeksforgeeks.org/problems/maximum-repeating-number4858/1) |[CPP](./Hashing/GFG_MostFreq.cpp) |Basic|O(1)||
|  39  |Merge Similar Items|[LC](https://leetcode.com/problems/merge-similar-items/) |[Java](./Hashing/MergeSimilarItems.java) ||O(n)||
|  40  |Minimum Consecutive Cards To Pick Up|[LC](https://leetcode.com/problems/minimum-consecutive-cards-to-pick-up/) |[Java](./Hashing/MinimumConsecutiveCardsToPickUp.java) ||O(n)||
|  41  |Minimum Replacements To Sort The Array|[LC](https://leetcode.com/problems/minimum-replacements-to-sort-the-array/) |[CPP](./Hashing/LC_2366_MinReplacementToSortTheArray.cpp) ||O(1)||
|  42  |Most Common Word|[LC](https://leetcode.com/problems/most-common-word/) |[Java](./Hashing/MostFrequentStringIgnoringBannedOnes.java) ||O(n)||
|  43  |Most Frequent Word In An Array Of Strings3528|[GFG](https://practice.geeksforgeeks.org/problems/most-frequent-word-in-an-array-of-strings3528/1#) |[CPP](./Hashing/GFG_MostFreqWordInArrayOfStrings.cpp) [Java](./Hashing/MostFrequentString.java) |Medium|O(1)||
|  44  |Number Of Arithmetic Triplets|[LC](https://leetcode.com/problems/number-of-arithmetic-triplets/) |[Java](./Hashing/CountNumberOfArithmeticTriplets.java) ||O(n)||
|  45  |Pairs Of Songs With Total Durations Divisible By 60|[LC](https://leetcode.com/problems/pairs-of-songs-with-total-durations-divisible-by-60/) |[CPP](./Hashing/LC_1010_PairsOfSongsWithTotalDurationsDivisibleBy60.cpp) ||O(1)||
|  46  |Partition Labels|[LC](https://leetcode.com/problems/partition-labels/) |[Java](./Hashing/PartitionLabels.java) ||O(n)||
|  47  |Points In Straight Line|[GFG](https://practice.geeksforgeeks.org/problems/points-in-straight-line/1#) |[Java](./Hashing/PointsInStraightLine.java) |Hard|O(n<sup>2</sup>)||
...
|  20  |Flatten A Multilevel Doubly Linked List|[LC](https://leetcode.com/problems/flatten-a-multilevel-doubly-linked-list/) [GFG](https://practice.geeksforgeeks.org/problems/flattening-a-linked-list/1) |[CPP](./Linked-List/GFG_FlatteningALL.cpp) [Java](./Linked-List/FlattenLinkedList.java) |Medium|O(n)||
...
|  33  |Kth Smallest Number In Multiplication Table|[LC](https://leetcode.com/problems/kth-smallest-number-in-multiplication-table/) |[CPP](./Searching/LC_668_KthSmallestNumberInMultiplication.cpp) [Java](./Searching/KthSmallestInMultiplicationTable.java) ||O(n)||
|  34  |Last Day Where You Can Still Cross|[LC](https://leetcode.com/problems/last-day-where-you-can-still-cross/) |[Java](./Searching/LastDayWhereYouCanStillCross.java) ||O(n<sup>2</sup>)||
|  35  |Maximum Distance Between A Pair Of Values|[LC](https://leetcode.com/problems/maximum-distance-between-a-pair-of-values/) |[Java](./Searching/MaximumDistanceBetweenAPairOfValues.java) ||O(n)||
|  36  |Maximum Value In A Bitonic Array3001|[GFG](https://practice.geeksforgeeks.org/problems/maximum-value-in-a-bitonic-array3001/1/) |[Java](./Searching/BitonicPoint.java) |Easy|O(n)||
|  37  |Minimum Element In A Sorted And Rotated Array3611|[GFG](https://practice.geeksforgeeks.org/problems/minimum-element-in-a-sorted-and-rotated-array3611/1/) |[Java](./Searching/MinimumElementInASortedAndRotatedArray.java) |Easy|O(n)||
|  38  |Minimum Limit Of Balls In A Bag|[LC](https://leetcode.com/problems/minimum-limit-of-balls-in-a-bag/) |[Java](./Searching/MinimumLimitOfBallsInABag.java) ||O(n)||
|  39  |My Calendar I|[LC](https://leetcode.com/problems/my-calendar-i/) |[CPP](./Searching/LC_729_MyCalendarI.cpp) ||O(n<sup>2</sup>)||
|  40  |Number Of Pairs 1587115620|[GFG](https://practice.geeksforgeeks.org/problems/number-of-pairs-1587115620/1/) |[Java](./Searching/NumberOfPairs.java) |Medium|O(n)||
|  41  |Pair With Given Sum In A Sorted Array4940|[GFG](https://practice.geeksforgeeks.org/problems/pair-with-given-sum-in-a-sorted-array4940/1) |[CPP](./Searching/GFG_PairWithGivenSumInSortedArray.cpp) [Java](./Searching/CountPairSumInSortedArray.java) |Easy|O(n)||
|  42  |Pair With Largest Sum Which Is Less Than K In The Array|[GFG](https://practice.geeksforgeeks.org/problems/pair-with-largest-sum-which-is-less-than-k-in-the-array/1/#) |[CPP](./Searching/GFG_PairWithLargestSumLessThanK.cpp) |null|O(1)||
|  43  |Search In Rotated Sorted Array|[LC](https://leetcode.com/problems/search-in-rotated-sorted-array/) |[CPP](./Searching/LC_33_SearchRotatedSortedArray.cpp) [Java](./Searching/SortedRotatedArraySearch.java) ||O(1)||
...
|  11  |Implement Stack Using Queues|[LC](https://leetcode.com/problems/implement-stack-using-queues/) |[Java](./Stack/StackUsingQueue.java) ||O(n)||
...
|  15  |Longest Valid Parentheses|[LC](https://leetcode.com/problems/longest-valid-parentheses/) |[CPP](./Stack/LC_32_LongestValidParentheses.cpp) [Java](./Stack/ValidParenthesesSubstring.java) ||O(1)||
|  16  |Maximum Of Minimum For Every Window Size3453|[GFG](https://practice.geeksforgeeks.org/problems/maximum-of-minimum-for-every-window-size3453/1#) |[CPP](./Stack/GFG_MaxOfMinForEveryWindowSize.cpp) [Java](./Stack/MaxOfMins.java) |Hard|O(1)||
|  17  |Min Stack|[LC](https://leetcode.com/problems/min-stack/) [GFG](https://practice.geeksforgeeks.org/problems/special-stack/1) |[CPP](./Stack/LC_155_MinStack.cpp) [Java](./Stack/StackWithFindMin.java) |Easy|O(1)||
|  18  |Minimum Swaps For Bracket Balancing2704|[GFG](https://practice.geeksforgeeks.org/problems/minimum-swaps-for-bracket-balancing2704/1) |[Java](./Stack/MinimumSwapsForBracketBalancing.java) |Easy|O(n<sup>2</sup>)||
|  19  |Next Greater Element I|[LC](https://leetcode.com/problems/next-greater-element-i/) |[CPP](./Stack/LC_469_NextGreaterElementI.cpp) [Java](./Stack/NextGreaterElement.java) ||O(1)||
|  20  |Number Of Visible People In A Queue|[LC](https://leetcode.com/problems/number-of-visible-people-in-a-queue/) |[Java](./Stack/NumberOfVisiblePeopleInAQueue.java) ||O(n<sup>2</sup>)||
|  21  |Online Stock Span|[LC](https://leetcode.com/problems/online-stock-span/) |[CPP](./Stack/LC_901_OnlineStackSpan.cpp) [Java](./Stack/OnlineStockSpanProblem.java) ||O(n<sup>2</sup>)||
|  22  |Simplify Path|[LC](https://leetcode.com/problems/simplify-path/) |[CPP](./Stack/LC_71_SimplifyPath.cpp) [Java](./Stack/ParsePath.java) ||O(1)||
|  23  |Sort A Stack|[GFG](https://practice.geeksforgeeks.org/problems/sort-a-stack/1#) |[CPP](./Stack/GFG_SortAStack.cpp) [Java](./Stack/SortStack.java) |Easy|O(1)||
|  24  |Stack Permutations|[GFG](https://practice.geeksforgeeks.org/problems/stack-permutations/1/) |[Java](./Stack/StackPermutations.java) |Medium|O(n<sup>2</sup>)||
|  25  |Steps To Make Array Non Decreasing|[LC](https://leetcode.com/problems/steps-to-make-array-non-decreasing/) |[Java](./Stack/StepsToMakeArrayNonDecreasing.java) ||O(n)||
|  26  |Stock Span Problem 1587115621|[GFG](https://practice.geeksforgeeks.org/problems/stock-span-problem-1587115621/1#) |[CPP](./Stack/GFG_StockSpanP.cpp) [Java](./Stack/StockSpanProblem.java) |Medium|O(1)||
|  27  |The Celebrity Problem|[GFG](https://practice.geeksforgeeks.org/problems/the-celebrity-problem/1) |[CPP](./Stack/GFG_TheCelebrityProblem.cpp) [Java](./Stack/CelebrityProblem.java) |Medium|O(n<sup>2</sup>)||
|  28  |Valid Parentheses|[LC](https://leetcode.com/problems/valid-parentheses/) |[CPP](./Stack/LC_20_ValidParentheses.cpp) [Java](./Stack/ValidParentheses.java) ||O(1)||
## Strings
...
|  115  |Maximum Sum Bst In Binary Tree|[LC](https://leetcode.com/problems/maximum-sum-bst-in-binary-tree/) |[CPP](./Tree/LC_1373_MaxSumBSTinBT.cpp) ||O(1)||
